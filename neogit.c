...
int main(int argc , char * argv[]){
    ...
    //part of add:
        ...
        FILE * staged_files = fopen(location,"r");
        char search[90];
        int flag=0;
        int counter=0;
        ...
        system("rm loc.txt");
        //now we get our present branch;
        system("ls > commits_det.txt");
        FILE * commits_det = fopen("commits_det.txt","r");
        ...
        system(command1);
        char N[90];
        strcpy(N,neogit_project_location+in_loc_len);
        printf("%s",N);
        char command2[200];
